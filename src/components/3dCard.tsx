...
export function ThreeDCardDemo({ image, name, description, live, github, tech, status }: ContentProps) {
    ...
    return (
        <CardContainer className="inter-var">
            <CardBody
                ...
                w-auto sm:w-[20rem] h-auto rounded-xl p-4 border"
            >
                ...
                {description && (
                    <CardItem
                        as="p"
                        translateZ="50"
                        className="text-neutral-500 text-sm mt-2 dark:text-neutral-400 line-clamp-2"
                    >
                        {description}
                    </CardItem>
                )}
                ...
                <div className="flex items-center justify-between mt-6">
                    ...
                    <CardItem
                        ...
                        rel="noopener noreferrer"
                        translateZ={20}
                        className="px-3 py-1.5 rounded-lg bg-black dark:bg-white 
